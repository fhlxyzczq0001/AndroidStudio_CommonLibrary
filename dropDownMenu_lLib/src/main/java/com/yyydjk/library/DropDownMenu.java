...
public class DropDownMenu extends LinearLayout {
     ...
     */
    public void setOnItemOnclick(int position,OnClickListener onClickListener) {
        this.OnItemOnclickPosition=position;
