...
import chzh.windy.camera.util.Camera2Utils;
...
//        CameraManager manager = (CameraManager) getSystemService(Context.CAMERA_SERVICE);
    ...
    private void setFlashMode() {
        ...
        switch (light_num) {
            case 0:
                mFlashBtn.setImageResource(R.drawable.btn_flash_off);
                ...
                break;
            case 1:
                mFlashBtn.setImageResource(R.drawable.btn_flash_on);
                mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
                ...
                break;
            case 2:
                mFlashBtn.setImageResource(R.drawable.btn_flash_all_on);
                mPreviewRequestBuilder.set(CaptureRequest.CONTROL_AE_MODE, CameraMetadata.CONTROL_AE_MODE_ON);
                mPreviewRequestBuilder.set(CaptureRequest.FLASH_MODE, CameraMetadata.FLASH_MODE_TORCH);
                //                mAnimationTextView.start("TORCH", DisplayFragment.WINDOW_TEXT_DISAPPEAR);
                break;
            case 3:
                mFlashBtn.setImageResource(R.drawable.btn_flash_auto);
