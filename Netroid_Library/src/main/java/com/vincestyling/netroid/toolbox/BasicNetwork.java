...
import com.vincestyling.netroid.ClientError;
import com.vincestyling.netroid.Delivery;
...
import com.vincestyling.netroid.RetryPolicy;
        ...
        while (true) {
            ...
            try {
                ...
                if(statusCode==HttpStatus.SC_MOVED_PERMANENTLY||statusCode==HttpStatus.SC_MOVED_TEMPORARILY){
                    ...
                    Header[] setCookieHeader =httpResponse.getHeaders("Set-Cookie");
                    String location="";
                    String setCookie="";
                    ...
                    if(setCookieHeader!=null&&setCookieHeader.length>0){
                        setCookie=setCookieHeader[0].getValue();
                    }
                    HashMap<String, String> map=new HashMap<>();
                    map.put("Location",location);
                    map.put("Set-Cookie",setCookie);
                    return new NetworkResponse(statusCode, responseContents, parseCharset(httpResponse),map);
                }
