...
public class QTabView extends TabView {
    ...
    private void initVerticalLayout(){
        VerticalLayout = new LinearLayout(mContext);
        VerticalLayout.setOrientation(LinearLayout.VERTICAL);
        VerticalLayout.setMinimumHeight(mMinHeight);
    ...
    private void initIconView() {
        ...
        } else if(mTabIcon.mConfigItemListener!=null){
            mTabIcon.mConfigItemListener.configItemImage(mIcon);
        }else {
    ...
    public void setChecked(boolean checked) {
        ...
        if (mChecked) {
            ...
            } else if(mTabIcon.mSelectedIconColor!=0){
                mIcon.setVisibility(View.VISIBLE);
                mIcon.setColorFilter(getResources().getColor(mTabIcon.mSelectedIconColor));
            }else {
                mIcon.setVisibility(View.GONE);
            }
        } else {
            ...
            if (mTabIcon.mNormalIcon != 0) {
                mIcon.setVisibility(View.VISIBLE);
                mIcon.setImageResource(mTabIcon.mNormalIcon);
            }else if(mTabIcon.mNormalIconColor != 0){
                mIcon.setVisibility(View.VISIBLE);
                mIcon.setColorFilter(getResources().getColor(mTabIcon.mNormalIconColor));
            } else {
                mIcon.setVisibility(View.GONE);
            }
        }
    ...
    public interface ConfigItemListener {
        public void configItemImage(ImageView imageView);
    ...
    public static class TabIcon {
        ...
        public int mNormalIconColor;
        public int mIconGravity;
        public int mIconWidth;
        public int mIconHeight;
        public ConfigItemListener mConfigItemListener;

        private TabIcon(int mSelectedIcon, int mNormalIcon, int mIconGravity, int mIconWidth, int mIconHeight,
                        int mSelectedIconColor,int mNormalIconColor,ConfigItemListener mConfigItemListener) {
            ...
            this.mSelectedIconColor = mSelectedIconColor;
            this.mNormalIconColor = mNormalIconColor;
            this.mConfigItemListener=mConfigItemListener;
        }
        ...
        public static class Builder {
            ...
            private ConfigItemListener mConfigItemListener;
            ...
            public Builder setIconColor(int selectedIconColor, int normalIconColor) {
                mSelectedIconColor = selectedIconColor;
                mNormalIconColor = normalIconColor;
                return this;
            }
            public Builder setConfigItemListener(ConfigItemListener configItemListener) {
                mConfigItemListener = configItemListener;
                return this;
            }
            ...
            public TabIcon build() {
                return new TabIcon(mSelectedIcon, mNormalIcon, mIconGravity, mIconWidth, mIconHeight,mSelectedIconColor,mNormalIconColor,mConfigItemListener);
            }
        }
    }
