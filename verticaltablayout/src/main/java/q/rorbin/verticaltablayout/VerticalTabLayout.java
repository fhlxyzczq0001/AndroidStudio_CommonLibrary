...
public class VerticalTabLayout extends ScrollView {
    ...
    private int mTabViewNormalColor;
    private int mTabViewSelectColor;
    ...
    public VerticalTabLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTabViewNormalColor = typedArray.getColor(R.styleable.VerticalTabLayout_indicator_tab_normal_color,
                context.getResources().getColor(R.color.colorAccent));
        mTabViewSelectColor = typedArray.getColor(R.styleable.VerticalTabLayout_indicator_tab_select_color,
                context.getResources().getColor(R.color.colorAccent));
    ...
    private void addTabWithMode(TabView tabView) {
        ...
        if (mTabStrip.indexOfChild(tabView) == 0) {
            ...
            if(mTabViewSelectColor!=mContext.getResources().getColor(R.color.colorAccent)){
                mSelectedTab.setBackgroundColor(mTabViewSelectColor);
            }
        }
    }
    ...
    public void setTabSelected(int position) {
        ...
        if (view != mSelectedTab) {
            ...
            if(mTabViewNormalColor!=mContext.getResources().getColor(R.color.colorAccent)){
                mSelectedTab.setBackgroundColor(mTabViewNormalColor);
            }
