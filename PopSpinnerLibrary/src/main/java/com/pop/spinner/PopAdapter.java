...
class PopAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (null == convertView) {
            ...
            viewHolder.imgSelectFlag = (ImageView) convertView.findViewById(R.id.imgSelectFlag);
        ...
        if (null != popModel) {
            ...
            if(popModel.isSelect()){
                viewHolder.imgSelectFlag.setVisibility(View.VISIBLE);
            }else {
                viewHolder.imgSelectFlag.setVisibility(View.GONE);
            }
