...
public class NiftyDialogBuilder extends Dialog implements DialogInterface {
    ...
    private void init(Context context) {
        ...
        icon_close= (ImageView) mDialogView.findViewById(R.id.icon_close);
    ...
    public NiftyDialogBuilder withCloseImage(int res) {
        if(res==-1){
            icon_close.setVisibility(View.GONE);
        }else{
            toggleView(icon_close, res);
            icon_close.setImageResource(res);
        }
        return this;
    }
    ...
    public NiftyDialogBuilder withButtonDrawable(int bt1,int bt2) {
        mButton1.setBackgroundResource(bt1);
        mButton2.setBackgroundResource(bt2);
        return this;
    }
