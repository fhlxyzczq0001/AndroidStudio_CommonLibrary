...
import com.videomodel.util.LightUtil;
import com.videomodel.util.PlayerUtil;
...
import static com.videomodel.util.PlayerUtil.dip2px;
        ...
        if (autoPlay) {
            ...
            if (!PlayerUtil.isNetworkConnected(context) && videoPath.startsWith("http")) {
                ...
                if (videoPath == null || videoPath.equals("")){
                    Toast.makeText(context, "未获取到视频信息", Toast.LENGTH_SHORT).show();
                    return;
                }
                //添加播放路径
                try {
